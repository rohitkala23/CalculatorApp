...
namespace Calculator {
    ...
    public partial class CalculatorDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EmployeeRow AddEmployeeRow(int Emp_Id, string Name, string FirstName, string MiddleName, string LastName, string Address, int Zip, string State, string Country, string Role, string PhoneNumber, string Email_Id) {
...
namespace Calculator.CalculatorDataSetTableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Employee] WHERE (([Emp_Id] = @Original_Emp_Id) AND ([Address] " +
                "= @Original_Address) AND ([Zip] = @Original_Zip) AND ([Role] = @Original_Role) A" +
                "ND ([PhoneNumber] = @Original_PhoneNumber) AND ([Email_Id] = @Original_Email_Id)" +
                ")";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Employee] ([Emp_Id], [Name], [FirstName], [MiddleName], [LastName], [Address], [Zip], [State], [Country], [Role], [PhoneNumber], [Email_Id]) VALUES (@Emp_Id, @Name, @FirstName, @MiddleName, @LastName, @Address, @Zip, @State, @Country, @Role, @PhoneNumber, @Email_Id);
SELECT Emp_Id, Name, FirstName, MiddleName, LastName, Address, Zip, State, Country, Role, PhoneNumber, Email_Id FROM Employee WHERE (Emp_Id = @Emp_Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employee] SET [Emp_Id] = @Emp_Id, [Name] = @Name, [FirstName] = @FirstName, [MiddleName] = @MiddleName, [LastName] = @LastName, [Address] = @Address, [Zip] = @Zip, [State] = @State, [Country] = @Country, [Role] = @Role, [PhoneNumber] = @PhoneNumber, [Email_Id] = @Email_Id WHERE (([Emp_Id] = @Original_Emp_Id) AND ([Address] = @Original_Address) AND ([Zip] = @Original_Zip) AND ([Role] = @Original_Role) AND ([PhoneNumber] = @Original_PhoneNumber) AND ([Email_Id] = @Original_Email_Id));
SELECT Emp_Id, Name, FirstName, MiddleName, LastName, Address, Zip, State, Country, Role, PhoneNumber, Email_Id FROM Employee WHERE (Emp_Id = @Emp_Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Emp_Id, Name, FirstName, MiddleName, LastName, Address, Zip, State, Countr" +
                "y, Role, PhoneNumber, Email_Id FROM dbo.Employee";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT Emp_Id, Name, FirstName, MiddleName, LastName, Address, Zip, State, Countr" +
                "y, Role, PhoneNumber, Email_Id FROM dbo.Employee";
        ...
        public virtual int Fill(CalculatorDataSet.EmployeeDataTable dataTable) {
        ...
        public virtual CalculatorDataSet.EmployeeDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CalculatorDataSet.EmployeeDataTable dataTable = new CalculatorDataSet.EmployeeDataTable();
        ...
        public virtual int FillBy(CalculatorDataSet.EmployeeDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CalculatorDataSet.EmployeeDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Emp_Id, string Original_Address, int Original_Zip, string Original_Role, string Original_PhoneNumber, string Original_Email_Id) {
        ...
        public virtual int Insert(int Emp_Id, string Name, string FirstName, string MiddleName, string LastName, string Address, int Zip, string State, string Country, string Role, string PhoneNumber, string Email_Id) {
        ...
        public virtual int Update(
                    ...
                    string Original_PhoneNumber, 
                    string Original_Email_Id) {
            return this.Update(Original_Emp_Id, Name, FirstName, MiddleName, LastName, Address, Zip, State, Country, Role, PhoneNumber, Email_Id, Original_Emp_Id, Original_Address, Original_Zip, Original_Role, Original_PhoneNumber, Original_Email_Id);
        }
    }
